...
public enum SpecificMaterial implements IMaterial {
	...
	WOOL_WHITE(Material.WOOL, new DyeColorValidator(0)),
	WOOL_ORANGE(Material.WOOL, new DyeColorValidator(1)),
	WOOL_MAGENTA(Material.WOOL, new DyeColorValidator(2)),
	WOOL_LIGHT_BLUE(Material.WOOL, new DyeColorValidator(3)),
	WOOL_YELLOW(Material.WOOL, new DyeColorValidator(4)),
	WOOL_LIME_GREEN(Material.WOOL, new DyeColorValidator(5)),
	WOOL_PINK(Material.WOOL, new DyeColorValidator(6)),
	WOOL_GRAY(Material.WOOL, new DyeColorValidator(7)),
	WOOL_LIGHT_GRAY(Material.WOOL, new DyeColorValidator(8)),
	WOOL_CYAN(Material.WOOL, new DyeColorValidator(9)),
	WOOL_PURPLE(Material.WOOL, new DyeColorValidator(10)),
	WOOL_BLUE(Material.WOOL, new DyeColorValidator(11)),
	WOOL_BROWN(Material.WOOL, new DyeColorValidator(12)),
	WOOL_GREEN(Material.WOOL, new DyeColorValidator(13)),
	WOOL_RED(Material.WOOL, new DyeColorValidator(14)),
	WOOL_BLACK(Material.WOOL, new DyeColorValidator(15)),

	CARPET_WHITE(Material.CARPET, new DyeColorValidator(0, Material.CARPET)),
	CARPET_ORANGE(Material.CARPET, new DyeColorValidator(1, Material.CARPET)),
	CARPET_MAGENTA(Material.CARPET, new DyeColorValidator(2, Material.CARPET)),
	CARPET_LIGHT_BLUE(Material.CARPET, new DyeColorValidator(3, Material.CARPET)),
	CARPET_YELLOW(Material.CARPET, new DyeColorValidator(4, Material.CARPET)),
	CARPET_LIME_GREEN(Material.CARPET, new DyeColorValidator(5, Material.CARPET)),
	CARPET_PINK(Material.CARPET, new DyeColorValidator(6, Material.CARPET)),
	CARPET_GRAY(Material.CARPET, new DyeColorValidator(7, Material.CARPET)),
	CARPET_LIGHT_GRAY(Material.CARPET, new DyeColorValidator(8, Material.CARPET)),
	CARPET_CYAN(Material.CARPET, new DyeColorValidator(9, Material.CARPET)),
	CARPET_PURPLE(Material.CARPET, new DyeColorValidator(10, Material.CARPET)),
	CARPET_BLUE(Material.CARPET, new DyeColorValidator(11, Material.CARPET)),
	CARPET_BROWN(Material.CARPET, new DyeColorValidator(12, Material.CARPET)),
	CARPET_GREEN(Material.CARPET, new DyeColorValidator(13, Material.CARPET)),
	CARPET_RED(Material.CARPET, new DyeColorValidator(14, Material.CARPET)),
	CARPET_BLACK(Material.CARPET, new DyeColorValidator(15, Material.CARPET)),
